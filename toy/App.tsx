...
const App: React.FC = () => {
  ...
  const handleNewScene = (type: 'Eagle' | 'Cat' | 'Rabbit' | 'Twins' | 'Guitar' | 'Microphone' | 'Speaker' | 'GoldRecord' | 'Singer' | 'Keyboard' | 'Drums' | 'Cassette' | 'Body') => {
  ...
  const handleRebuild = (type: 'Eagle' | 'Cat' | 'Rabbit' | 'Twins' | 'Guitar' | 'Microphone' | 'Speaker' | 'GoldRecord' | 'Singer' | 'Keyboard' | 'Drums' | 'Cassette' | 'Body') => {
    const generator = Generators[type];
    if (generator && engineRef.current) {
